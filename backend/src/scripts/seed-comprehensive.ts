...
const seedDatabase = async () => {
  try {
    ...
    const technologiesData: any[] = [
      { appId: 1, name: 'SAP ECC', code: 'ECC', description: 'SAP ECC 6.0' },
      { appId: 1, name: 'SAP S/4HANA', code: 'S4H', description: 'SAP S/4HANA' },
      { appId: 1, name: 'SAP Fiori', code: 'FIORI', description: 'SAP Fiori UX' },
      { appId: 1, name: 'SAP BW', code: 'BW', description: 'SAP Business Warehouse' },
      { appId: 2, name: 'Sales Cloud', code: 'SALES', description: 'Salesforce Sales Cloud' },
      { appId: 2, name: 'Service Cloud', code: 'SERVICE', description: 'Salesforce Service Cloud' },
      { appId: 2, name: 'Marketing Cloud', code: 'MKTG', description: 'Salesforce Marketing Cloud' },
      { appId: 3, name: 'Oracle DB', code: 'ODB', description: 'Oracle Database' },
      { appId: 3, name: 'Oracle Fusion', code: 'FUSION', description: 'Oracle Fusion Applications' },
      { appId: 4, name: 'React', code: 'REACT', description: 'React.js Framework' },
      { appId: 4, name: 'Node.js', code: 'NODE', description: 'Node.js Runtime' },
      { appId: 4, name: 'Python', code: 'PY', description: 'Python Language' },
      { appId: 4, name: '.NET', code: 'DOTNET', description: 'Microsoft .NET Framework' },
      { appId: 4, name: 'Java', code: 'JAVA', description: 'Java Platform' },
      { appId: 4, name: 'Angular', code: 'NG', description: 'Angular Framework' },
      { appId: 4, name: 'Vue.js', code: 'VUE', description: 'Vue.js Framework' },
      { appId: 4, name: 'Django', code: 'DJANGO', description: 'Django Framework' },
      { appId: 4, name: 'Spring Boot', code: 'SPRING', description: 'Spring Boot Framework' },
      { appId: 4, name: 'Express.js', code: 'EXPRESS', description: 'Express.js Framework' },
      { appId: 4, name: 'Flask', code: 'FLASK', description: 'Flask Framework' },
    ];
    ...
    const rolesData: any[] = [
      { appId: 1, technologyId: 1, name: 'SAP ECC Consultant', code: 'ECC-CON', level: 'Senior' },
      { appId: 1, technologyId: 2, name: 'SAP S/4HANA Architect', code: 'S4H-ARCH', level: 'Lead' },
      { appId: 1, technologyId: 2, name: 'SAP S/4HANA Developer', code: 'S4H-DEV', level: 'Mid' },
      { appId: 1, technologyId: 3, name: 'SAP Fiori Developer', code: 'FIORI-DEV', level: 'Mid' },
      { appId: 1, technologyId: 4, name: 'SAP BW Consultant', code: 'BW-CON', level: 'Senior' },
      { appId: 2, technologyId: 5, name: 'Salesforce Developer', code: 'SFDC-DEV', level: 'Mid' },
      { appId: 2, technologyId: 5, name: 'Salesforce Admin', code: 'SFDC-ADM', level: 'Junior' },
      { appId: 2, technologyId: 6, name: 'Service Cloud Specialist', code: 'SVC-SPEC', level: 'Senior' },
      { appId: 3, technologyId: 8, name: 'Oracle DBA', code: 'ORA-DBA', level: 'Senior' },
      { appId: 3, technologyId: 9, name: 'Oracle Fusion Developer', code: 'FUSION-DEV', level: 'Mid' },
      { appId: 4, technologyId: 10, name: 'React Developer', code: 'REACT-DEV', level: 'Mid' },
      { appId: 4, technologyId: 11, name: 'Node.js Developer', code: 'NODE-DEV', level: 'Mid' },
      { appId: 4, technologyId: 12, name: 'Python Developer', code: 'PY-DEV', level: 'Mid' },
      { appId: 4, technologyId: 13, name: '.NET Developer', code: 'NET-DEV', level: 'Senior' },
      { appId: 4, technologyId: 14, name: 'Java Developer', code: 'JAVA-DEV', level: 'Senior' },
      { appId: 4, technologyId: 15, name: 'Full Stack Developer', code: 'FS-DEV', level: 'Lead' },
    ];
