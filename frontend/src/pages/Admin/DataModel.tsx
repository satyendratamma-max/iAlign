  ...
  const entities: Entity[] = [
    ...
    },
    {
      ...
      relationships: [
        ...
        { type: 'hasMany', target: 'ResourceCapabilities', description: 'Resource can have multiple capabilities' },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'resourceCapabilityId', type: 'INTEGER', required: false, foreignKey: 'ResourceCapabilities.id', description: 'Resource capability being allocated' },
        { name: 'projectRequirementId', type: 'INTEGER', required: false, foreignKey: 'ProjectRequirements.id', description: 'Project requirement being fulfilled' },
        { name: 'matchScore', type: 'DECIMAL(5,2)', required: false, description: 'Capability match score (0-100) - auto-calculated' },
        { name: 'allocationPercentage', type: 'DECIMAL(5,2)', required: true, description: 'Allocation percentage (0-100)' },
        { name: 'allocatedHours', type: 'DECIMAL(10,2)', required: false, description: 'Total allocated hours' },
        ...
        { name: 'roleOnProject', type: 'VARCHAR(100)', required: false, description: 'Role in this project' },
        { name: 'allocationType', type: 'VARCHAR(50)', required: true, default: 'Shared', description: 'Allocation type (Shared, Dedicated)' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        ...
        { type: 'belongsTo', target: 'ResourceCapabilities', description: 'Allocation uses a specific resource capability' },
        { type: 'belongsTo', target: 'ProjectRequirements', description: 'Allocation fulfills a project requirement' },
      ],
    },
    {
      name: 'Apps',
      table: 'Apps',
      description: 'Application portfolio (master table for cascaded taxonomy)',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'name', type: 'VARCHAR(200)', required: true, unique: true, description: 'Application name (e.g., SAP, Salesforce)' },
        { name: 'code', type: 'VARCHAR(50)', required: true, unique: true, description: 'Short code for display (e.g., SAP, SFDC)' },
        { name: 'category', type: 'VARCHAR(100)', required: false, description: 'Application category (ERP, CRM, Cloud Platform)' },
        { name: 'vendor', type: 'VARCHAR(200)', required: false, description: 'Vendor/publisher name' },
        { name: 'isGlobal', type: 'BOOLEAN', required: true, default: true, description: 'Whether this is a global/generic category' },
        { name: 'status', type: 'VARCHAR(50)', required: true, default: 'Active', description: 'Status (Active, Deprecated, Sunset)' },
        { name: 'criticality', type: 'VARCHAR(50)', required: false, description: 'Business criticality (Critical, High, Medium, Low)' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'hasMany', target: 'Technologies', description: 'App can have multiple technologies' },
        { type: 'hasMany', target: 'Roles', description: 'App can have multiple roles' },
        { type: 'hasMany', target: 'ResourceCapabilities', description: 'App referenced in resource capabilities' },
        { type: 'hasMany', target: 'ProjectRequirements', description: 'App referenced in project requirements' },
      ],
    },
    {
      name: 'Technologies',
      table: 'Technologies',
      description: 'Technologies within applications (cascaded from Apps)',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'appId', type: 'INTEGER', required: false, foreignKey: 'Apps.id', description: 'Parent app (null = global technology)' },
        { name: 'name', type: 'VARCHAR(200)', required: true, description: 'Technology name (e.g., ABAP, Apex, Lambda)' },
        { name: 'code', type: 'VARCHAR(50)', required: true, description: 'Short code for display' },
        { name: 'stackType', type: 'VARCHAR(50)', required: false, description: 'Tech stack type (Frontend, Backend, Database, Infrastructure, Tool)' },
        { name: 'description', type: 'TEXT', required: false, description: 'Technology description' },
        { name: 'isActive', type: 'BOOLEAN', required: true, default: true, description: 'Active status' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'belongsTo', target: 'Apps', description: 'Technology may belong to an app (or be global)' },
        { type: 'hasMany', target: 'Roles', description: 'Technology can have multiple roles' },
        { type: 'hasMany', target: 'ResourceCapabilities', description: 'Technology referenced in resource capabilities' },
        { type: 'hasMany', target: 'ProjectRequirements', description: 'Technology referenced in project requirements' },
      ],
    },
    {
      name: 'Roles',
      table: 'Roles',
      description: 'Roles within technologies (cascaded from Apps and Technologies)',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'appId', type: 'INTEGER', required: false, foreignKey: 'Apps.id', description: 'Parent app (null = global role)' },
        { name: 'technologyId', type: 'INTEGER', required: false, foreignKey: 'Technologies.id', description: 'Parent technology (null = app-level or global role)' },
        { name: 'parentRoleId', type: 'INTEGER', required: false, foreignKey: 'Roles.id', description: 'Parent role for hierarchy' },
        { name: 'name', type: 'VARCHAR(200)', required: true, description: 'Role name (e.g., SAP ABAP Developer, Full Stack Developer)' },
        { name: 'code', type: 'VARCHAR(50)', required: true, description: 'Short code for display' },
        { name: 'level', type: 'VARCHAR(50)', required: false, description: 'Seniority level (Junior, Mid, Senior, Lead, Principal, Architect)' },
        { name: 'description', type: 'TEXT', required: false, description: 'Role description' },
        { name: 'isActive', type: 'BOOLEAN', required: true, default: true, description: 'Active status' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'belongsTo', target: 'Apps', description: 'Role may belong to an app' },
        { type: 'belongsTo', target: 'Technologies', description: 'Role may belong to a technology' },
        { type: 'belongsTo', target: 'Roles', description: 'Role may have a parent role' },
        { type: 'hasMany', target: 'Roles', description: 'Role can have child roles' },
        { type: 'hasMany', target: 'ResourceCapabilities', description: 'Role referenced in resource capabilities' },
        { type: 'hasMany', target: 'ProjectRequirements', description: 'Role referenced in project requirements' },
      ],
    },
    {
      name: 'ResourceCapabilities',
      table: 'ResourceCapabilities',
      description: 'Resource skills/capabilities (App/Technology/Role combinations)',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'resourceId', type: 'INTEGER', required: true, foreignKey: 'Resources.id', description: 'Resource reference' },
        { name: 'appId', type: 'INTEGER', required: true, foreignKey: 'Apps.id', description: 'Application reference' },
        { name: 'technologyId', type: 'INTEGER', required: true, foreignKey: 'Technologies.id', description: 'Technology reference' },
        { name: 'roleId', type: 'INTEGER', required: true, foreignKey: 'Roles.id', description: 'Role reference' },
        { name: 'proficiencyLevel', type: 'VARCHAR(50)', required: true, default: 'Intermediate', description: 'Proficiency (Beginner, Intermediate, Advanced, Expert)' },
        { name: 'yearsOfExperience', type: 'INTEGER', required: false, description: 'Years of experience with this capability' },
        { name: 'isPrimary', type: 'BOOLEAN', required: true, default: false, description: 'Whether this is the primary capability for the resource' },
        { name: 'lastUsedDate', type: 'DATE', required: false, description: 'When this capability was last used' },
        { name: 'certifications', type: 'TEXT', required: false, description: 'Related certifications' },
        { name: 'isActive', type: 'BOOLEAN', required: true, default: true, description: 'Active status' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'belongsTo', target: 'Resources', description: 'Capability belongs to a resource' },
        { type: 'belongsTo', target: 'Apps', description: 'Capability references an app' },
        { type: 'belongsTo', target: 'Technologies', description: 'Capability references a technology' },
        { type: 'belongsTo', target: 'Roles', description: 'Capability references a role' },
        { type: 'hasMany', target: 'Allocations', description: 'Capability can be used in multiple allocations' },
      ],
    },
    {
      name: 'ProjectRequirements',
      table: 'ProjectRequirements',
      description: 'Project skill requirements (App/Technology/Role combinations needed)',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'projectId', type: 'INTEGER', required: true, foreignKey: 'Projects.id', description: 'Project reference' },
        { name: 'appId', type: 'INTEGER', required: true, foreignKey: 'Apps.id', description: 'Required application' },
        { name: 'technologyId', type: 'INTEGER', required: true, foreignKey: 'Technologies.id', description: 'Required technology' },
        { name: 'roleId', type: 'INTEGER', required: true, foreignKey: 'Roles.id', description: 'Required role' },
        { name: 'requiredCount', type: 'INTEGER', required: true, default: 1, description: 'Number of resources needed' },
        { name: 'fulfilledCount', type: 'INTEGER', required: true, default: 0, description: 'Number of resources allocated' },
        { name: 'proficiencyLevel', type: 'VARCHAR(50)', required: true, default: 'Intermediate', description: 'Minimum proficiency required' },
        { name: 'minYearsExp', type: 'INTEGER', required: false, description: 'Minimum years of experience required' },
        { name: 'priority', type: 'VARCHAR(50)', required: true, default: 'Medium', description: 'Priority (Critical, High, Medium, Low)' },
        { name: 'startDate', type: 'DATE', required: false, description: 'When capability is needed from' },
        { name: 'endDate', type: 'DATE', required: false, description: 'When capability is needed until' },
        { name: 'description', type: 'TEXT', required: false, description: 'Requirement details' },
        { name: 'isFulfilled', type: 'BOOLEAN', required: true, default: false, description: 'Whether requirement is fully satisfied' },
        { name: 'isActive', type: 'BOOLEAN', required: true, default: true, description: 'Active status' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'belongsTo', target: 'Projects', description: 'Requirement belongs to a project' },
        { type: 'belongsTo', target: 'Apps', description: 'Requirement references an app' },
        { type: 'belongsTo', target: 'Technologies', description: 'Requirement references a technology' },
        { type: 'belongsTo', target: 'Roles', description: 'Requirement references a role' },
        { type: 'hasMany', target: 'Allocations', description: 'Requirement can be fulfilled by multiple allocations' },
      ],
    },
  ];
