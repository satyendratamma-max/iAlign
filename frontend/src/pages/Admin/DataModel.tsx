...
const DataModel = () => {
  ...
  const entities = [
    ...
    },
    {
      ...
      relationships: [
        { type: 'hasMany', target: 'Portfolios', description: 'A domain can have multiple portfolios' },
    ...
    },
    {
      name: 'Portfolios',
      table: 'Portfolios',
      description: 'Project portfolios within domains',
      fields: [
        { name: 'id', type: 'INTEGER', required: true, primaryKey: true, description: 'Auto-incrementing primary key' },
        { name: 'domainId', type: 'INTEGER', required: false, foreignKey: 'Domains.id', description: 'Parent domain reference' },
        { name: 'name', type: 'VARCHAR(200)', required: true, description: 'Portfolio name' },
        { name: 'description', type: 'TEXT', required: false, description: 'Portfolio description' },
        { name: 'createdDate', type: 'DATETIME', required: true, description: 'Creation timestamp' },
        { name: 'modifiedDate', type: 'DATETIME', required: true, description: 'Last modification timestamp' },
      ],
      relationships: [
        { type: 'belongsTo', target: 'Domains', description: 'Portfolio belongs to a domain' },
        { type: 'hasMany', target: 'Projects', description: 'Portfolio can have multiple projects' },
      ],
    },
    {
      name: 'Teams',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'portfolioId', type: 'INTEGER', required: false, foreignKey: 'Portfolios.id', description: 'Parent portfolio reference' },
      ...
      relationships: [
        { type: 'belongsTo', target: 'Portfolios', description: 'Project belongs to a portfolio' },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'domainId', type: 'INTEGER', required: false, foreignKey: 'Domains.id', description: 'Domain reference' },
        { name: 'portfolioId', type: 'INTEGER', required: false, foreignKey: 'Portfolios.id', description: 'Portfolio reference' },
      ...
      relationships: [
        ...
        { type: 'belongsTo', target: 'Portfolios', description: 'Resource belongs to a portfolio' },
